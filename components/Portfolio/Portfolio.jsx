                        ...
                        <div className={styles.portfolioItem} key={i}>
                            <div className={styles.portfolioItem__Img}>
                                <Image
                                    ...
                                    height={230}
                                /> 
                                    <motion.div  className={styles.linksLay} whileHover={{opacity:[0,1]}} transition={{duration:0.25, staggerChildren:0.5, ease: 'easeInOut'}}>
                            ...
                            <div className={styles.textos}>
                                <Link href={e.link} target={"_blank"}>{`> ${e.titulo}`}</Link>
                                <p>{e.desc}</p>
